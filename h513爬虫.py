...
def getChapters():
    ...
    book_url = 'https://www.h513.com/book/108726/'
    base_url = 'https://www.h513.com/book/108726/'
    pageTotal = 2 + 59
    pageCount = 2
...
def getContent(url):
    ...
    article_regx = '<div id="chaptercontent" class="Readarea ReadAjax_content">(.*)请收藏本站'
    article = re.findall(article_regx, response_2.text)
    content = article[0].replace('<br /><br />', '\n\n').replace("�"," ")
